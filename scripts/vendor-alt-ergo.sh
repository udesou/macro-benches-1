#!/usr/bin/env bash
# Download and extract alt-ergo + its dune-compatible deps into vendor/.
# Scaffolding: fmt, logs, camlzip (need dune overlays) and ppx_deriving/ppxlib
# are not vendored yet, see README. System deps: libgmp-dev, zlib1g-dev.
set -euo pipefail
